...
## Objetivo
Implementar um cognitive framework, implementando ideias e teorias de diversos campos distintos: 
- Sociedade da mente, de Marvel Minsk, especialmente frames e agents
- Frame Semantics, de Charles Fillmore
- Image Schemas, de Lakoff and Johnson
- Conceptual spaces, related to the work of Gärdenfors
- Commonsense Psychology, de Gordon&Hobbs
- Conceptual Blending
...
- 1 Dimension: **CURVE**: um conceito conceptualizado como CURVE deve ser formado por pelo menos dois outros conceitos (os quais são conceptualizados como **POINT**s). Está associado à ideia de LINK, PATH, STREAM, AXIS, etc. A princípio, todos os conceitos que fazem parte de uma CURVE são da mesma natureza.
    
- 2 Dimensions: **AREA**: um conceito conceptualizado como AREA deve ser formado por pelo menos dois conceitos **CURVE** (ou seja, no mínimo 3 POINTs). Está associado à ideia de SURFACE, PLAN, etc. Uma AREA pode conter outros tipos de conceitos.
    
- 3 Dimensions: **OBJECT**: é o tipo de conceito mais complexo, formed by 2 or more **AREA**s. Um OBJECT pode agregar ou conter outros OBJECT e  pode ser decomposto em OBJECTs distintos.  
